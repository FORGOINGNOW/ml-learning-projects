"""总控脚本：按顺序运行数据生成、特征构造、训练、评估和报告生成。"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the battery NN multiclass experiment pipeline.")
    ...
    run([py, "src/visualize_data.py", "--config", runtime_config], root)
